...
# ============================================================
# Crypto Tide Engine V10.8 Expectancy-Graded Production Runtime
...
GRADE_EXPECTANCY_REFERENCE = {
    ...
    "A-": {
        "label": "CAN TAKE / BASE SYSTEM EDGE",
        "expectancy": 0.0030,
        "note": "Broad strict-quality pool; weaker and more regime-sensitive than A/A+.",
    },
    "B": {
...
def select_current_watchlist(results: pd.DataFrame) -> list[str]:
    ...
    send_tg(
        "🔄 Crypto Tide V10.8 all-eligible watchlist refreshed\n\n"
...
def close_research_position(
    ...
    send_tg(f"""{exit_icon} Crypto Tide V10.8 {exit_title}: {symbol}
...
def tide_grade(
    ...
    if aplus:
        ...
        core_downtrend
        and volume < NEGATIVE_CORE_MAX_VOLUME
    ):
        grade = "C"
        reasons = [
        ...
        # B includes all near-miss/mixed-quality signals. We intentionally do
        # not call all of them negative because the research did not support
...
A  = recommended
A- = positive base-system edge / can take
...
def start_monitor(symbols: list[str]) -> None:
    if not symbols:
        send_tg(
            "⚠️ Crypto Tide V10.8 found no robust-eligible symbols.\n"
