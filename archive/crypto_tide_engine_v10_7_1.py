...
# ============================================================
# Crypto Tide Engine V10.7.1 All-Signals Quality Display Runtime
...
def select_current_watchlist(results: pd.DataFrame) -> list[str]:
    ...
    send_tg(
        "🔄 Crypto Tide V10.7.1 all-eligible watchlist refreshed\n\n"
...
def close_research_position(
    ...
    send_tg(f"""🏁 Crypto Tide V10.7.1 EXIT: {symbol}
...
All signals are recorded for later comparison.
    ...
    if confirmed:
        ...
        if has_scored_setup:
            ...
            if position_opened:
                ...
                decision = "qualified_but_portfolio_blocked"
                reason = "quality_passed_but_portfolio_capacity_blocked"
            else:
                decision = "observed_nonproduction_signal"
...
def start_monitor(symbols: list[str]) -> None:
    if not symbols:
        send_tg(
            "⚠️ Crypto Tide V10.7.1 found no robust-eligible symbols.\n"
    ...
    send_tg(
        "✅ Crypto Tide Engine V10.7.1 all-signals monitor started\n\n"
