...
# ============================================================
# Crypto Tide Engine V10.8.2 B+ Minimum Telegram Runtime
...
def select_current_watchlist(results: pd.DataFrame) -> list[str]:
    ...
    send_tg(
        "🔄 Crypto Tide V10.8.2 all-eligible watchlist refreshed\n\n"
...
def close_research_position(
    ...
    send_tg(f"""{exit_icon} Crypto Tide V10.8.2 {exit_title}: {symbol}
...
def start_monitor(symbols: list[str]) -> None:
    if not symbols:
        send_tg(
            "⚠️ Crypto Tide V10.8.2 found no robust-eligible symbols.\n"
    ...
    send_tg(
        "✅ Crypto Tide Engine V10.8 expectancy-graded monitor started\n\n"
