...
def build_model_frame(df15: pd.DataFrame, df1h: pd.DataFrame) -> pd.DataFrame:
    ...
    # Normalise timestamp precision before merge_asof.
    # Newer pandas versions may produce ms precision for API timestamps
    # but us precision after adding a Timedelta, which causes MergeError.
