...
# -*- coding: utf-8 -*-
"""
V11.3 FAST — 15m NEXT SCORE BAND CHAMPIONSHIP
=============================================
...
def parse_args():
    ...
    p.add_argument("--output-dir", type=Path, default=Path("v11_3_next_band_fast"))
...
def main():
    ...
    print("=" * 100)
    print("V11.3 FAST — 15m NEXT SCORE BAND CHAMPIONSHIP")
    print("=" * 100)
