...
# ============================================================
# Crypto Tide Engine V10.8.2.2 Maintenance Runtime
...
def tide_grade(
    ...
    if aplus:
        ...
        next_rescue = (
            ...
            and risk_pct <= NEXT_RESCUE_MAX_RISK
        )
        if next_rescue:
            grade = "A-"
            reasons = [
                ...
                f"Hard-stop risk {risk_pct:.2%} <= {NEXT_RESCUE_MAX_RISK:.2%}",
...
def send_quality_signal_alert(
    ...
    risk_mark = (
        ...
        if risk["risk_pct"] <= PRODUCTION_MAX_HARD_STOP_RISK_PCT
            ...
            "⚠️ NEAR"
            if risk["risk_pct"] <= PRODUCTION_MAX_HARD_STOP_RISK_PCT + 0.005
            else "❌ FAIL"
        )
    )
...
def start_monitor(symbols: list[str]) -> None:
    ...
    send_tg(
        "✅ Crypto Tide Engine V10.8.2.2 maintenance monitor started\n\n"
